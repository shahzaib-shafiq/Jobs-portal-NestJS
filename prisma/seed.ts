...
async function main() {
  ...
  const candidate1 = await prisma.user.create({
    data: {
      ...
      adress: '123 Main St, San Francisco, CA 94102',
      phone: '+1234567893',
      isVerified: true,
    },
  });
  ...
  const candidate2 = await prisma.user.create({
    data: {
      ...
      adress: '456 Oak Ave, New York, NY 10001',
      phone: '+1234567894',
      isVerified: true,
    },
  });
  ...
  const candidate3 = await prisma.user.create({
    data: {
      ...
      adress: '789 Pine Rd, Seattle, WA 98101',
      phone: '+1234567895',
      isVerified: true,
    },
  });
  ...
  const candidate4 = await prisma.user.create({
    data: {
      ...
      adress: '321 Elm St, Austin, TX 78701',
      phone: '+1234567896',
      isVerified: true,
    },
  });
  ...
  const candidate5 = await prisma.user.create({
    data: {
      ...
      adress: '654 Maple Dr, Boston, MA 02101',
      phone: '+1234567897',
      isVerified: true,
    },
  });
